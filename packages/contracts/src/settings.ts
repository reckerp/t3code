...
const PullRequestFocusTeamId = TrimmedNonEmptyString.check(Schema.isMaxLength(64));
export type PullRequestFocusTeamId = typeof PullRequestFocusTeamId.Type;
/** GitHub login length is 39; other hosts are similar. */
const PullRequestFocusTeamMember = TrimmedNonEmptyString.check(Schema.isMaxLength(39));
